...
const light = {
  ...
  captionOverlay:   'rgba(0,0,0,0.45)' as string,
  loadingOverlay:   'rgba(255,255,255,0.7)' as string,
  menuBtnOverlay:   'rgba(30,30,30,0.65)' as string,
  // Misc
  ...
  inputPlaceholder: '#9fa5ae' as string,
...
const dark = {
  ...
  surfaceStrong:    'rgba(255,255,255,0.08)' as string,
  ...
  textPrimary:      '#e2eaf5' as string,
  textSecondary:    '#9fb3cc' as string,
  textHint:         '#5c7391' as string,
  ...
  inputBorder:      'rgba(255,255,255,0.15)' as string,
  inputBg:          'rgba(255,255,255,0.08)' as string,
  modalOverlay:     'rgba(0,0,0,0.80)' as string,
  captionOverlay:   'rgba(0,0,0,0.65)' as string,
  loadingOverlay:   'rgba(13,21,32,0.80)' as string,
  menuBtnOverlay:   'rgba(8,16,28,0.80)' as string,
  ...
  captionBoxText:   '#e2eaf5' as string,
